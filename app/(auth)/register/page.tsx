...
export default function RegisterPage() {
    ...
    const onError = () => {
        if (errors.username) {
            ...
            toast.error(errors.password.message, { position: "top-center" })
        } else if (errors.confirmPassword) {
            toast.error(errors.confirmPassword.message, { position: "top-center" })
        }
    }
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit, onError)} className="flex flex-col gap-6">
            <div className="flex flex-col items-center gap-2 text-center">
                <h1 className="text-2xl font-bold">Registrate y empieza a jugar</h1>
            ...
            <div className="grid gap-4">
                <div className="grid gap-2">
                    ...
                    <Input
                        ...
                        {...register('username', {
                            required: {
                                value: true,
                                message: "Debes de ingresar un nombre de usuario"
                            }
                        })}
                    />
                </div>
                <div className="grid gap-2">
                    ...
                    <Input
                        ...
                        {...register('email', {
                            required: {
                                value: true,
                                message: "Debes de ingresar tu correo electronico para registrarte"
                            }
                        })}
                    />
                </div>
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <Input
                            ...
                            {...register('password', {
                                required: {
                                    value: true,
                                    message: "Debes de ingresar una contraseña para poder registrarte"
                                }
                            })}
                        />
                    </div>
                    <div>
                        <div className="flex items-center justify-between">
                            <Label htmlFor="confirm-password" className="text-sm mb-1">Confirmar Contraseña</Label>
                        </div>
                        <Input
                            id="confirm-password"
                            type="password"
                            ...
                            {...register('confirmPassword', {
                                required: {
                                    value: true,
                                    message: "Debes de confirmar la contraseña para poder crear tu cuenta"
                                }
                            })}
                        />
                    </div>
                </div>
                <Button type="submit" className="w-full mt-2 text-lg cursor-pointer" disabled={loading}>
            ...
            <div className="grid grid-cols-3 gap-4">
                <Button variant="outline" type="button" size="lg" className="h-10 cursor-pointer">
                ...
                <Button variant="outline" type="button" size="lg" className="h-10 cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25" className="h-5 w-5">
